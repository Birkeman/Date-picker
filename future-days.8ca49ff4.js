...
window.getFutureDays = function () {
  ...
  var monthName = (0, _dateFns.format)(monthAdd, "MMMM yyyy");
  $(".js-month-name").html(monthName);
  var m = (0, _dateFns.formatISO)(monthAdd);
  $(".js-month-name").attr("data-helper", m);
  $(".js-month-var").val(m);
  var startMonth = (0, _dateFns.startOfMonth)(monthAdd);
  var endMonth = (0, _dateFns.endOfMonth)(monthAdd);
...
},{}]},{},["../../../../AppData/Roaming/npm/node_modules/parcel-bundler/src/builtins/hmr-runtime.js","js/future-days.js"], null)
//# sourceMappingURL=/future-days.8ca49ff4.js.map