...
window.getPastDays = function () {
  ...
  var monthSub = (0, _dateFns.subMonths)(currentMonth, 1);
  var monthName = (0, _dateFns.format)(monthSub, "MMMM yyyy");
  $(".js-month-name").html(monthName);
  var m = (0, _dateFns.formatISO)(monthSub);
  $(".js-month-name").attr("data-helper", m);
  $(".js-month-var").val(m);
  $(".js-calendar").html("");
  var startSelected = $(".js-start-date").val();
  var endSelected = $(".js-end-date").val();
  var startMonth = (0, _dateFns.startOfMonth)(monthSub);
  var endMonth = (0, _dateFns.endOfMonth)(monthSub);
  ...
  var minusOne = (0, _dateFns.subDays)(startMonth, 1);
  var minusTwo = (0, _dateFns.subDays)(startMonth, 2);
  var minusThree = (0, _dateFns.subDays)(startMonth, 3);
  var minusFour = (0, _dateFns.subDays)(startMonth, 4);
  var minusFive = (0, _dateFns.subDays)(startMonth, 5);
  var minusSix = (0, _dateFns.subDays)(startMonth, 6);

  if (firstDay == true) {
    $(".js-calendar").append('<li class="single-date disabled fixed" data-date="' + (0, _dateFns.format)(minusOne, "MM.dd.yyy") + '">' + (0, _dateFns.getDate)(minusOne) + '</li>');
  } else if (secondDay == true) {
    $(".js-calendar").append('<li class="single-date disabled fixed" data-date="' + (0, _dateFns.format)(minusTwo, "MM.dd.yyy") + '">' + (0, _dateFns.getDate)(minusTwo) + '</li><li class="single-date disabled fixed" data-date="' + (0, _dateFns.format)(minusOne, "MM.dd.yyy") + '">' + (0, _dateFns.getDate)(minusOne) + '</li>');
  ...
  $(".enabled").click(selectDate); /////GET SELECTED DATES///////
...
},{}]},{},["../../../../AppData/Roaming/npm/node_modules/parcel-bundler/src/builtins/hmr-runtime.js","js/past-days.js"], null)
//# sourceMappingURL=/past-days.d6cc7be6.js.map