...
window.currentMonth = function () {
  ...
  var lightStartDate = (0, _dateFns.format)(startDate, "yyyy-MM-dd");
  ...
  var monthName = (0, _dateFns.format)(startDate, "MMMM yyyy");
  $(".js-month-name").html(monthName);
  var m = (0, _dateFns.formatISO)(startDate);
  console.log("M = " + m);
...
},{}]},{},["../../../../AppData/Roaming/npm/node_modules/parcel-bundler/src/builtins/hmr-runtime.js","js/current-month.js"], null)
//# sourceMappingURL=/current-month.625a42d6.js.map