...
var startMonth = dateFns.startOfMonth(startDate);
var endMonth = dateFns.endOfMonth(startDate);
...
var firstDay = dateFns.isMonday(startMonth);
console.log("FIRST DAY : " + firstDay);
console.log("START MONTH : " + startMonth);
var secondDay = dateFns.isTuesday(startMonth);
var thirdDay = dateFns.isWednesday(startMonth);
var fourthDay = dateFns.isThursday(startMonth);
var fifthDay = dateFns.isFriday(startMonth);
var sixthDay = dateFns.isSaturday(startMonth);
var minusOne = dateFns.subDays(startMonth, 1);
var minusTwo = dateFns.subDays(startMonth, 2);
var minusThree = dateFns.subDays(startMonth, 3);
var minusFour = dateFns.subDays(startMonth, 4);
var minusFive = dateFns.subDays(startMonth, 5);
var minusSix = dateFns.subDays(startMonth, 6);
...
result2.forEach(function (date) {
  ...
  $(".js-calendar").append("<li class='single-date' data-date=" + dateFns.formatISO(date, {
    representation: "date"
  }) + ">" + date.getDate() + "</li>");
...
window.currentDate(); ////////////////DISABLE DATES BEFORE TODAY///
